    ...
    (function () {
      ...
      (e.copyObject = function (t) {
        ...
        (n = (function () {
          var t;
          return (
            (t = document.createEvent("Events")), t.initEvent("test", !0, !0), t.preventDefault(), t.defaultPrevented
          );
        })()),
        ...
        e.Location = (function () {
          ...
          return (
            ...
            (t.prototype.getPath = function () {
              var t, e;
              return null != (t = null != (e = this.requestURL.match(/\/\/[^\/]*(\/[^?;]*)/)) ? e[1] : void 0)
                ? t
                : "/";
            }),
        ...
        e.History = (function () {
          ...
          return (
            ...
            (r.prototype.onPopState = function (t) {
              var r, n, o, i;
              return this.shouldHandlePopState() && (i = null != (n = t.state) ? n.turbolinks : void 0)
            ...
            for (this.elements = {}, n = 0, a = t.length; a > n; n++)
              (u = t[n]),
                u.nodeType === Node.ELEMENT_NODE &&
                  ((s = u.outerHTML),
                  (r = null != (e = this.elements)[s] ? e[s] : (e[s] = { type: i(u), tracked: o(u), elements: [] })),
                  r.elements.push(u));
          }
          var e, r, n, o, i;
          return (
          ...
          return (
            ...
            (e.prototype.createScriptElement = function (t) {
              ...
              return "false" === t.getAttribute("data-turbolinks-eval")
                ? t
                : ((e = document.createElement("script")), (e.textContent = t.textContent), (e.async = !1), r(e, t), e);
            }),
            (r = function (t, e) {
              var r, n, o, i, s, a, u;
        ...
        e.Controller = (function () {
          ...
          return (
            ...
            (r.prototype.startVisitToLocationWithAction = function (t, r, n) {
              var o;
              return e.supported
                ? ((o = this.getRestorationDataForIdentifier(n)), this.startVisit(t, r, { restorationData: o }))
                : (window.location = t);
            }),
