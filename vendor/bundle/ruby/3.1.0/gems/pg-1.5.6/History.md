...
- Disable nonblocking mode while large object calls. [#498](https://github.com/ged/ruby-pg/pull/498)
  Since pg-1.3.0 libpq's "lo\_\*" calls failed when a bigger amount of data was transferred.
...
- Add PG::CONNECTION\_\* constants for conn.status of newer PostgreSQL versions.
...
- Update sync*\* and async*\_ query method descriptions and document the aliases.
  The primary documentation is now at the async\_\_ methods which are the default since pg-1.1.
...
- Provide PG::Connection#sync*\* and PG::Connection#async*\* query methods for explicit calling synchronous or asynchronous libpq API.
...
- Add **EXTENSIONS** to Solaris/SmartOS for Ruby >= 2.3.x. [#236](https://github.com/ged/ruby-pg/pull/236)
...
- Add support for PG*DIAG*\*\_NAME error fields of PostgreSQL-9.3 ([#161](https://github.com/ged/ruby-pg/pull/161)).
